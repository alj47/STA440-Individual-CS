...
# Random Forest
rf.fit.model <- randomForest(Student.Achievement.Rating ~ Enrollment + Percent.Asian + Percent.Black + Economic.Need.Index + Principal.Experience.yrs + Teachers.Rating.pct, data = train, ntree = 100, 
    importance = TRUE)
